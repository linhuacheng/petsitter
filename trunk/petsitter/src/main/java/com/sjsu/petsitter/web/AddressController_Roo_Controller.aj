...
import com.sjsu.petsitter.web.AddressController;
...
privileged aspect AddressController_Roo_Controller {
    ...
    public String AddressController.show(@PathVariable("id") BigInteger id, Model uiModel) {
    ...
    public String AddressController.updateForm(@PathVariable("id") BigInteger id, Model uiModel) {
        populateEditForm(uiModel, addressService.findAddress(id));
        return "addresses/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String AddressController.delete(@PathVariable("id") BigInteger id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
